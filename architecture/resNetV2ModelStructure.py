...
"""
Поскольку модель Facenet была обучена в более старых версиях TensorFlow, данный файл 
используется для определения архитектуры модели в новых версиях TensorFlow, 
чтобы можно было загрузить вес предварительно обученной модели
"""
